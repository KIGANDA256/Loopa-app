...
<template>
    <Nav-bar />
    <div>
        <h5 class="text-2xl text-center text-navy">Alert</h5>
    </div>
    <div>
        <h1 class="text-3xl text-center text-blue-700">Loopa-App</h1>
        <p class="text-center">Report a Crime</p>
        <section
            class="flex flex-col mx-20 my-20 h-200 border-2 border-gray-300 rounded-lg px-50 py-16 shadow-lg bg-white ">
            ...
            <div class="mt-4">
                ...
                <input type="file" multiple class="block w-full mt-2 p-2 border border-gray-300 rounded"
                    id="evidence-upload" accept=".pdf, .jpg, .jpeg, .mp4">
